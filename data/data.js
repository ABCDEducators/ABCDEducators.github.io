...
const title = "ABCDEducators";
const phone = '9696894360';
const email = 'contact@abcdeducators.in';
const wappMsg = "I'm%20here%20regarding%20the%20enquiry%20for%20ABCDE%20education%20classes%20for%20my%20child";
const copyright = "&copy;ABCDE Educators 2020-2021";
const developer = "Mohit Joshi";
const developerSite = "https://github.com/joshiCoding";

// Email Settings
const mailSender = "Office@abcdeducators.in";
const mailReciever = 'contact@abcdeducators.in';
...
const heroPara = "The best teachers from whole world are now at your doorstep, with better learning techniques in your native accents.";


// course section content
const coursePara = "We have the most curated list of the courses available from basic classroom courses to crash courses to help your child with those little details and excel as your child should be.";

const courseList = ['Grade 1<sup>st</sup> To 12<sup>th</sup>',
